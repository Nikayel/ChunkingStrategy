...
````
There are 149 chunks```

**One thing that surprised you or didn't match your expectations:**

````

I thought Chunk woul dstart with 300 chars then subsequent would be 350 but turns out its 250 instead when i looked closer at the sliding window logic```
